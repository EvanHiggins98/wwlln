...
%    axis square
    ...
    title([StormName,' ',month,'/',day,'/',num2str(year),' (Courtesy of WWLLN/UW/NWRA/DigiPen)'])
    filenameBig = [StormName,'_',num2str(year),'_',month,'_',day];
...
%	saveas(gcf,filename6,'fig')
    ...
    if false
        ...
        axis square;
        filenameSmall = [StormName,'_Script_',num2str(ScriptNumber),'_PlotSize_',num2str(NewPlot),'_GridSize_',num2str(GridSize),'_',num2str(year),'_',month,'_',day];
