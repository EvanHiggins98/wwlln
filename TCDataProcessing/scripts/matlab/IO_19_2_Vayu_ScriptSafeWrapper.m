addpath('/home/connor12123/Documents/Django_Projects/wwlln_raw_data_collector/script/matlab');
addpath('/home/connor12123/Documents/Django_Projects/wwlln_raw_data_collector/script/matlab');
script_prefix = 'IO_19_2_Vayu_';
...
% so we are using our own log file to transfer error output to our debug logs.
	errorLog = fopen('/home/connor12123/Documents/Django_Projects/wwlln_raw_data_collector/script/matlab/ScriptStdErr.txt', 'At');
	fprintf(errorLog, ['\n', errorMessage]);
	fclose(errorLog);
