"""
Django settings for wwlln project.
...
SECRET_KEY = 'django-insecure-b&+__5-zc9%lo86t8ms0x$f*9l6fm-l&m2-sxn)*4eddry5upy'
...
WSGI_APPLICATION = 'wwlln.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME':     credentials.DATABASE_INFO['NAME'],
        'USER':     credentials.DATABASE_INFO['USER'],
        'PASSWORD': credentials.DATABASE_INFO['PASSWORD'],
